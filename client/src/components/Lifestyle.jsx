...
function Lifestyle() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://newsapi.org/v2/everything?q=apple&from=2024-03-22&to=2024-03-22&sortBy=popularity&apiKey=c78ac8912da347fa96ff947a51879847');
